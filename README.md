...
$$
\ \text{허용 서버 지연 시간 (초)} = \left(\frac{\text{초당 점수 - 최대 아이템 점수}}{\text{초당 점수}}\right) \times 2 \
$$


| 스테이지 | 스테이지 ID | 초당 점수 | 아이템 해금 | 최대 아이템 점수 | 오차 점수 (tolerance) | 허용 서버 지연 시간 (초) |
|----------|-------------|-----------|-------------|------------------|-----------------------|-------------------------|
| 1        | 1000        | 1         | [1]         | 10               | 12*1=12               | \((12 - 10) / 1) * 2 = 4.0\)        |
| 2        | 1001        | 2         | [1, 2]      | 20               | 12*2=24               | \((24 - 20) / 2) * 2 = 4.0\)        |
| 3        | 1002        | 3         | [1, 2, 3]   | 30               | 12*3=36               | \((36 - 30) / 3) * 2 = 4.0\)        |
| 4        | 1003        | 4         | [2, 3, 4]   | 40               | 12*4=48               | \((48 - 40) / 4) * 2 = 4.0\)        |
| 5        | 1004        | 5         | [3, 4, 5]   | 50               | 12*5=60               | \((60 - 50) / 5) * 2 = 4.0\)        |
| 6        | 1005        | 6         | [4, 5, 6]   | 60               | 12*6=72               | \((72 - 60) / 6) * 2 = 4.0\)        |
| 7        | 1006        | 7         | [6]         | 60               | 12*7=84               | \((84 - 60) / 7) * 2 = 6.9\)        |
